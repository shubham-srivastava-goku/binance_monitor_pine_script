...
async function sendSignal(side, comment) {
  try {
    const payload = {
      code: comment, // Matches TradingView comments
    };

    // WUNDER_WEBHOOK = https://wtalerts.com/bot/trading_view
    // payload = { comment: 'ENTER-LONG_BINANCE_API3USDT_BOT-NAME-RDSh9d_5M_ed68632a927ae2e945f77585' }
